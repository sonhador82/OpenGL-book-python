...
class Object3D:
    ...
    # calculate transformation of thid object3d relative
    ...
    # return single list cotainig all descendants
    def getDescendantList(self):
        # master list of all descendatn nodes
        descendants = []
        # nodes to be added to desc list
